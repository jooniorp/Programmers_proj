...
'''
model_save_path_ie = 'kc_bert_ie_classifier_20230115.pth'
model_save_path_ns = 'kc_bert_ns_classifier_20230115.pth'
model_save_path_tf = 'kc_bert_tf_classifier_20230115.pth'
model_save_path_pj = 'kc_bert_pj_classifier_20230115.pth'
'''

file_list = os.listdir('/home/ubuntu/model1/m1_server')
recent_date = 0
...
model_save_path_ie = '/home/ubuntu/model1/m1_server/kc_bert_ie_classifier_{}.pth'.format(recent_date)
model_save_path_ns = '/home/ubuntu/model1/m1_server/kc_bert_ns_classifier_{}.pth'.format(recent_date)
model_save_path_tf = '/home/ubuntu/model1/m1_server/kc_bert_tf_classifier_{}.pth'.format(recent_date)
model_save_path_pj = '/home/ubuntu/model1/m1_server/kc_bert_pj_classifier_{}.pth'.format(recent_date)
# 모델 아키텍처 생성
...
def draw_circle(data):
    ...
    plt.rc('font', size=30)
    plt.pie(ratio_ie, labels=label_ie, autopct='%.2f%%')
    img_path1 = '/home/ubuntu/img_mbti/save_ie.png'
    delete_file(img_path1)
    plt.savefig(img_path1)
    plt.close()
    plt.pie(ratio_ns, labels=label_ns, autopct='%.2f%%')
    img_path2 = '/home/ubuntu/img_mbti/save_ns.png'
    delete_file(img_path2)
    plt.savefig(img_path2)
    plt.close()
    plt.pie(ratio_tf, labels=label_tf, autopct='%.2f%%')
    img_path3 = '/home/ubuntu/img_mbti/save_tf.png'
    delete_file(img_path3)
    plt.savefig(img_path3)
    plt.close()
    plt.pie(ratio_pj, labels=label_pj, autopct='%.2f%%')
    img_path4 = '/home/ubuntu/img_mbti/save_pj.png'
    ...
    img_path = '/home/ubuntu/img_mbti/save.png'
...
#Model1 main함수
def task1(file_path,input_mbti):
    #나의 mbti 
    my_fin = ''
    #상대방의 mbti 
    op_fin=''
    ...
    my_image_path = '/home/ubuntu/img_mbti/img_{}.png'.format(my_fin)
    op_image_path = '/home/ubuntu/img_mbti/img_{}.png'.format(op_fin)
    
    
    #여기서 db에 저장해야됨
    if my_fin==input_mbti.lower():
        stm.save_to_mongodb(my_chat)
...
with gr.Blocks() as iface1:
    ...
    """
    # 당신의 카톡속 MBTI는!?
    카카오톡 텍스트 뽑기 가이드 : https://moonjae.tistory.com/29
    """
    )
    with gr.Row():
...
iface2 = gr.Interface(
    fn=task2,
    inputs=[gr.Textbox(label="문장을 입력하세요"), gr.Dropdown(["INTJ", "INTP", "ENTJ", "ENTP", "INFJ", "INFP", "ENFJ", "ENFP", "ISTJ", "ISFJ", "ESTJ", "ESFJ", "ISTP", "ISFP", "ESTP", "ESFP"], label="원하는 MBTI를 입력하세요")],
    outputs=gr.Textbox(),
