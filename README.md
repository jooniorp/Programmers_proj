...
✔️Frond-end
<img src="./img_mbti/gradio.png" width="100">
✔️Back-end
...
<br/>따라서 Kcbert모델을 파인튜닝하고 학습하는 데에 있어 16가지의 MBTI를 분류하거나 정확도를 측정하기에 데이터가 적고 부정확하다<br/>
또한, 성격이란 것의 기준 자체가 애매모호하고 명확하게 구분할 수 있는 정의가 없기 때문에 mbti 분류task자체가 굉장히 높은 정확도를 가지기 어려운 task이다.
<br/>
<br/>하지만, 모델 파라미터를 주기적으로 업데이트 하는 코드를 작성하여 구현함으로 채팅데이터가 점점 쌓이면 더 정확한 분류를 할 수 있음이 기대되고
